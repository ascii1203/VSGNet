### VSGNet
Code for CVPR 2020 paper [**VSGNet:Spatial Attention Network for Detecting Human Object Interactions Using Graph Convolutions.**](https://arxiv.org/abs/2003.05541) 


## Installation
1. Clone repository :
```Shell
git clone https://github.com/ascii1203/VSGNet.git
```
